...
public class InsertImage {
	...
	public static void inserirImagem(String nomeCenario, String caminhoCenario, String nomeImagem,
			String nomeImagemEvidencia) {
		try {
			...
			if (!exportFile.exists()) {
				...
				// Atualiza o arquivo caso o mesmo já exista
			...
			System.out.println(
					"Erro ao inserir screenshot no arquivo Word. Favor fechar o arquivo caso o mesmo esteja aberto");
		}
